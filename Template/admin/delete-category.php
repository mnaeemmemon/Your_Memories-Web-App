...
<?php
	if($_POST)
	{
		...
		{
			echo '<script>alert("Please Enter the Category Name First")</script>';
		}
	}
?>
...
<head>
	...
	<!-- PAGE TITLE HERE ============================================= -->
	<title>Delete Category | Admin Portal</title>
	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<h4 class="breadcrumb-title">Delete Category</h4>
						...
						<div class="widget-inner">
							<form class="edit-profile m-b30" method="post" >
								<div class="row">
									...
									<div class="col-12">
    									<input type="submit" class="btn" value="Delete" name="delete"></input>
									</div>
								</div>
							</form>
						</div>
