					...
					<div class="widget-box">
						...
						$res=mysqli_query($con,"select * from products");
							...
							while($row=mysqli_fetch_array($res))
							{
								...
								echo '<div class="card-courses-list bookmarks-bx">';
								...
								echo '<div class="card-courses-list-bx">';
								echo '<ul class="card-courses-view">';
								echo '<li>';
								echo "<h3 class='m-b0'>$name</h3>";
								echo '</li>';
								echo '<li class="card-courses-price">';
								echo "<h4 class='text-primary m-b0'>Price: $price Rs</h4>";
								echo '</li>';
								echo '</ul>';
								echo '</div>';
								echo '<div class="row card-courses-dec" style="margin-top:40px">';
								echo '<div class="col-md-12">';
								echo "<p>$description</p>";
								echo "<h5>Remaining Quantity: $quantity</h5>";
								echo '</div>';
								echo '</div>';
								echo '</div>';
								echo '</div>';
